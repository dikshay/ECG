...
public class DBHelper extends SQLiteOpenHelper{
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + HealthMonitorReaderContract.AccelerometerDataEntry.TABLE_NAME + " (" +
                    HealthMonitorReaderContract.AccelerometerDataEntry._ID + " INTEGER PRIMARY KEY," +
                    ...
                    HealthMonitorReaderContract.AccelerometerDataEntry.TIMESTAMP + "INTEGER" + COMMA_SEP +
                    " )";
